...
from src.models import MLPResult
...
class MLPVisualization:
    ...
    def __init__(self, dash: Dash, results: list[MLPResult], X: DataFrame, y: Series):
        [a, b] = results
    ...
    def generate_visualizations(self, result: MLPResult, X: DataFrame, y: Series):
    ...
    # Topologie des MLP Modells mit Darstellung der Gewichte zwischen den Neuronen
